...
interface IconExportDocumentProps {
    className?: string;
    fill?: boolean;
    duotone?: boolean;
}

const IconExportDocument: FC<IconExportDocumentProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <svg
...
export default IconExportDocument;
