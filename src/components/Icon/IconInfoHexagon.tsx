...
const IconInfoHexagon: FC<IconInfoHexagonProps> = ({ className, fill = false, duotone = true, width, height }) => {
    return (
        <>
            {!fill ? (
                <svg width={width ?? '20'} height={height ?? '20'} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
