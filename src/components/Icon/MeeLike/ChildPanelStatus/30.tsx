...
interface IconChildPanelStoppedProps {
    className?: string;
    width?: number;
    height?: number;
}

const IconChildPanelStopped: FC<IconChildPanelStoppedProps> = ({ className, width, height }) => {
    return (
...
export default IconChildPanelStopped;
