...
interface IconOrderPartiallyCompletedProps {
    className?: string;
    width?: number;
    height?: number;
}

const IconOrderPartiallyCompleted: FC<IconOrderPartiallyCompletedProps> = ({ className, width = 24, height = 24 }) => {
    return (
...
export default IconOrderPartiallyCompleted;
