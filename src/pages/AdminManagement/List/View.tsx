...
import IconExportDocument from '@/components/Icon/IconExportDoucment';
...
const AdminManagementListView: FC = () => {
    const {
        isLoading,
        isSubmitting,
        page,
                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-center'>
                        <div>
                            ...
                            >
                                ...
                                <span className='pl-2'>เพิ่มผู้ใช้งาน</span>
                            </button>
                        </div>
                        ...
                        <div className='flex flex-row gap-3 items-center'>
                            ...
                            <button
                                className={clsx('ml-auto btn bg-meelike-dark text-white text-center shadow hover:!bg-gray-300 hover:!text-black w-auto h-[38px]', {
                        ...
                        {/* <div>
                            <button
                                ...
                                onClick={onExport}
                            >
                                <IconExportDocument className='w-4 text-white' fill />
                                <span className='pl-2'>นำออกข้อมูล</span>
                            </button>
                        </div> */}
                    </div>
                </div>
...
export default AdminManagementListView;
